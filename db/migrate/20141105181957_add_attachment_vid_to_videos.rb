class AddAttachmentVidToVideos < ActiveRecord::Migration
  def self.up
      add_column :videos, :vid_file_name,    :string
      add_column :videos, :vid_content_type, :string
      add_column :videos, :vid_file_size,    :integer
      add_column :videos, :vid_updated_at,   :datetime
    end
